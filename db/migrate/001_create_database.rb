class CreateDatabase < ActiveRecord::Migration[5.1]
  def self.up
	ActiveRecord::Schema.define(version: 0) do
	  ...
	  create_table "Enfants", id: :integer, default: nil, force: :cascade do |t|
		t.string "Nom", limit: 45, null: false
		t.string "Prenom", limit: 45, null: false
		t.datetime "DateNaissance", null: false
	  end

	  create_table "EtatsCivils", id: :integer, default: nil, force: :cascade do |t|
		t.string "type", limit: 45, null: false
	  end

	  create_table "Etudes", id: :integer, default: nil, force: :cascade do |t|
	  ...
	  create_table "Versions", id: :integer, comment: "table pour sauvegarder plusieurs versions d'un même enregistrement", default: nil, force: :cascade do |t|
