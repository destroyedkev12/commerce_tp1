...
class EmployeursControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create employeur" do
    assert_difference('Employeur.count') do
      post employeurs_url, params: { employeur: { Adresses_id: @employeur.Adresses_id, Nom: @employeur.Nom } }
    end
  ...
  test "should update employeur" do
    patch employeur_url(@employeur), params: { employeur: { Adresses_id: @employeur.Adresses_id, Nom: @employeur.Nom } }
