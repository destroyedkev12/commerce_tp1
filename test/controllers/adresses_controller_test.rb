...
class AdressesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create adress" do
    assert_difference('Adress.count') do
      post adresses_url, params: { adress: { CodePostal: @adress.CodePostal, NumeroCivique: @adress.NumeroCivique, Procince: @adress.Procince, Rue: @adress.Rue, Ville: @adress.Ville, id: @adress.id } }
    end
  ...
  test "should update adress" do
    patch adress_url(@adress), params: { adress: { CodePostal: @adress.CodePostal, NumeroCivique: @adress.NumeroCivique, Procince: @adress.Procince, Rue: @adress.Rue, Ville: @adress.Ville, id: @adress.id } }
