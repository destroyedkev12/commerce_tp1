...
class InstitutionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create institution" do
    assert_difference('Institution.count') do
      post institutions_url, params: { institution: { Adresses_id: @institution.Adresses_id, Nom: @institution.Nom, id: @institution.id } }
    end
  ...
  test "should update institution" do
    patch institution_url(@institution), params: { institution: { Adresses_id: @institution.Adresses_id, Nom: @institution.Nom, id: @institution.id } }
